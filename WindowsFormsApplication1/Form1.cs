...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		{
			BolleHeaven bolleHeaven = new BolleHeaven(trælle.getJohn());
			string text = "";
			int num = new Random().Next(10) + 3;
			for (int i = 0; i < num; i++)
			{
				if (text.Length == 0)
				{
					text += bolleHeaven.constantIteration(1);
				}
				if (i == new Random().Next(num))
				{
					text += bolleHeaven.vowel(1);
				}
				if (i == new Random().Next(num))
				{
					text += bolleHeaven.constantIteration(1);
				...
				if (i == new Random().Next(num))
				{
					text += bolleHeaven.constantIteration(2);
				}
				if (i == new Random().Next(num))
				{
					text += bolleHeaven.vowel(1);
